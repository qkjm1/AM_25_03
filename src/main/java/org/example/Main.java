...
//                        }
//                    }
//                        System.out.print("비밀번호 다시 입력바람: ");
//                        String loginPwcc = sc.next().trim();
//                        if (loginPw.equals(loginPwcc)) {
...
//                }
    ...
    private static void memberTestData () {
        System.out.println("==멤버 테스트 데이터 생성");
        memberList.add(new Member(1,Util.getNowStr(),"abc1","abc1","abc1"));
        memberList.add(new Member(2,Util.getNowStr(),"abc2","abc2","abc2"));
        memberList.add(new Member(3,Util.getNowStr(),"abc3","abc3","abc3"));
    ...
    class Member {
        ...
        public Member(int id, String regDate, String loginPw, String loginId, String name) {
            this.id = id;
            this.regDate = regDate;
            this.loginPw = loginPw;
            this.loginId = loginId;
